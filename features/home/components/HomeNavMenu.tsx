...
const menuSurface = "home-themed-menu absolute right-0 top-[calc(100%+0.5rem)] z-80 grid w-56 gap-0.5 overflow-hidden rounded-2xl border p-1.5 text-popover-foreground backdrop-blur-xl";
const menuItem = "home-themed-menu-item flex items-center gap-2.5 whitespace-nowrap rounded-xl px-3.5 py-3 text-sm font-medium text-muted-foreground no-underline transition-colors hover:text-foreground";
